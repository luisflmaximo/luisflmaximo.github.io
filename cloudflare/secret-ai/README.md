...
Este Worker serve de proxy entre a aba `secret` e a API da Groq, para que a chave nunca fique exposta no browser.
...
- O segredo esperado pelo Worker e `GROQ_API_KEY`.
